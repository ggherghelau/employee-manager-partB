...
`+t,e.compileDebug&&(t="rethrow = rethrow || "+G.toString()+`;
...
`,y.message+="Or, if you meant to create an async function, pass `async: true` as an option.")),y}var I=e.client?a:function(V){var Te=function(je,z){var M=E.shallowCopy({},V);return z&&(M=E.shallowCopy(M,z)),we(je,e)(M)};return a.apply(e.context,[V||{},d,Te,G])};if(e.filename&&typeof Object.defineProperty=="function"){var O=e.filename,be=s.basename(O,s.extname(O));try{Object.defineProperty(I,"name",{value:be,writable:!1,enumerable:!1,configurable:!0})}catch(y){}}return I},generateSource:function(){var t=this.opts;t.rmWhitespace&&(this.templateText=this.templateText.replace(/[\r\n]+/g,`
